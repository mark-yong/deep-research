    ...
    def from_runnable_config(
        ...
        if result.search_api == SearchAPI.SEARXNG and result.mcp_config is None:
            ...
            result.mcp_prompt = (
                ...
                "Use it to find up-to-date information from the web. "
                "Each search call takes a query string and returns relevant web results with titles, URLs, and snippets. "
                "Call the 'search' tool with a query when you need information from the internet."
            )
